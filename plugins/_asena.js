...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'asena ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *Asena Owner Edition* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *Jarvis by Abdurehman* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );
        }
    }));
}
    ...
    Asena.addCommand({pattern: 'heyasena ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
