...
const NEED_WORD = "*Must Enter a Word*"
...
if (Config.WORKTYPE == 'private') {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg ,quoted: message.data,})
    ...
    Asena.addCommand({pattern: 'glowttp ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg ,quoted: message.data,})
    ...
    Asena.addCommand({pattern: 'glowttp ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
