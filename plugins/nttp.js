...
/*Asena.addCommand({ pattern: 'ttp ?(.*)', fromMe: true, desc: Lang.TTP_DESC, dontAddCommand:true }, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'Made For Kioni Ndungu' })
...
Asena.addCommand({ pattern: 'animettp ?(.*)', fromMe: true, desc: Lang.ANİME_DESC, dontAddCommand:true }, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'In help of Kioni Ndungu' })
...
Asena.addCommand({ pattern: 'colorful ?(.*)', fromMe: true, desc: Lang.COLORFUL_DESC, dontAddCommand:true }, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.video, { mimetype: Mimetype.mp4, caption: 'Made For Kioni Ndungu' })
