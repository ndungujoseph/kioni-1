...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please Wait.')}`);
    ...
    conn.on('chat-update', async m => {
        ...
        if (config.SUPPORT == '905824317852-1612300121') {     
        ...
        if (config.SUPPORT2 == '907311384572-1617736751') {     
        ...
        events.commands.map(
            ...
            async (command) =>  {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if ((config.OWN == "919628516236,0" && msg.key.fromMe === false && command.fromMe === true &&
